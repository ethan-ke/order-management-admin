...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    name: 'Orders',
    meta: { title: 'Order Management', icon: 'el-icon-s-order' },
    children: [
      {
        path: 'index',
        name: 'OrdersIndex',
        component: () => import('@/views/orders/index'),
        meta: { title: 'Orders', icon: 'el-icon-s-order' }
      }
    ]
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Merchant Management', icon: 'el-icon-s-order' },
    children: [
      {
        path: 'index',
        name: 'MerchantIndex',
        component: () => import('@/views/merchant/index'),
        meta: { title: 'Merchants', icon: 'el-icon-user' }
      }
    ]
  },
  {
